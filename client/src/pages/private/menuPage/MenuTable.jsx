                  ...
                  item.dishes.map((i) => (
                    ...
                    >
                      <p className="text-gray-600 text-md ">
                        {i.name}
                        <span className="text-purple-400 font-semibold italic ml-2 mt-2 ">
                          {i.price.toFixed(2)}
        ...
        >
          {selectedItem && (
            <div className="flex relative flex-col justify-center items-center py-8">
              ...
              <div
                className="flex flex-col justify-center items-center  border-2 w-[70%] border-gray-300 p-3"
                ref={divToCaptureRef}
              >
                ...
                {selectedItem.dishes &&
                  selectedItem.dishes.map((dish) => (
                    ...
                    >
                      <h5 className="text-gray-800 text-lg font-semibold uppercase tracking-wider">
                        {dish.type}
                      </h5>
